...
class GridTestCase(unittest.TestCase):
    ...
    def test_attack(self):
        ...
        self.assertEqual(grid.attack(0, 0), SUBMARINE)
        self.assertEqual(grid.attack(1, 0), SUBMARINE)
        self.assertEqual(grid.attack(2, 0), SUBMARINE)
        self.assertEqual(grid.attack(3, 0), None)
        self.assertEqual(grid.attack(0, 1), None)
        self.assertEqual(grid.attack(9, 9), BATTLESHIP)
        self.assertEqual(grid.attack(8, 9), BATTLESHIP)
        self.assertEqual(grid.attack(7, 9), BATTLESHIP)
        self.assertEqual(grid.attack(6, 9), BATTLESHIP)
